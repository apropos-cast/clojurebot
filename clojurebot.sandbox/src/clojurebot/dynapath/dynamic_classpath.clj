(ns clojurebot.dynapath.dynamic-classpath
...
(def ^{:doc "A map that provides implementations of can-read? and can-add? that
  return true.  Useful as a base for a DynamicClasspath implementation."}
