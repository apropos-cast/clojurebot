(ns clojurebot.dynapath.util
  "Abstracts the getURLs and addURL functionality of URLClassLoader to a protocol."
  (:require
   [clojurebot.dynapath.dynamic-classpath :as dc]
   clojurebot.dynapath.defaults)) ;; trigger the default implementations
...
(defn classpath-urls
  "Returns the URLs for the given ClassLoader, or nil if the ClassLoader is not
  readable."
  [cl]
...
(defn all-classpath-urls
  "Walks up the parentage chain for a ClassLoader, concatenating any URLs it
  retrieves.
